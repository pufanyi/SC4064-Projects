...
\subsection*{12) Scaling}
This is the scaling result where we fix the total problem size and add more GPUs. Large matrices scale very welly, while smaller matrices scale less well because the n square communication cost becomes a bigger fraction of the total time.
